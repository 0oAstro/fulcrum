<h1 align="center">Fulcrum Core</h1>

<p align="center">
  Stateful agent runtime.
</p>

Release docs use the Fulcrum package names. The source workspace manifests still keep inherited package names until the namespace migration is complete.
...
```typescript
import { Agent } from "fulcrum-core";
import { getModel } from "fulcrum-ai";
...
```typescript
import { Agent, streamProxy } from "fulcrum-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "fulcrum-core";
