...
// ============================================================================
// OAuth API key resolution from ~/.fulcrum/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".fulcrum", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.fulcrum/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.fulcrum/auth.json
 */
...
/** Path to the real Fulcrum config directory. */
export const FULCRUM_AGENT_DIR = join(homedir(), ".fulcrum");

/**
 * Get an AuthStorage instance backed by ~/.fulcrum/auth.json
