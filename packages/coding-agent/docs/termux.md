...
Fulcrum runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# From an existing Fulcrum source checkout
cd /path/to/fulcrum
npm ci
...
Create `~/.fulcrum/AGENTS.md` to help the agent understand the Termux environment:
