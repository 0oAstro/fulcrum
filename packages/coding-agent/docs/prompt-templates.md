> Fulcrum can create prompt templates. Ask it to build one for your workflow.
...
Fulcrum loads prompt templates from:

- Global: `~/.fulcrum/prompts/*.md`
- Project: `.fulcrum/prompts/*.md`
