<h1 align="center">Fulcrum TUI</h1>
...
```typescript
import { TUI, Text, Editor, ProcessTerminal, matchesKey } from "fulcrum-tui";
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "fulcrum-tui";
...
```typescript
import { Container, type Focusable, Input } from "fulcrum-tui";
...
Renders Kitty or iTerm2 terminal graphics when supported. Set `fallbackOnly: true` to show compact image metadata instead; Fulcrum uses this metadata-only mode.
...
```typescript
import { CombinedAutocompleteProvider } from "fulcrum-tui";
...
```typescript
import { matchesKey, Key } from "fulcrum-tui";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "fulcrum-tui";
...
```typescript
import { matchesKey, Key, truncateToWidth } from "fulcrum-tui";
import type { Component } from "fulcrum-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "fulcrum-tui";
import type { Component } from "fulcrum-tui";
