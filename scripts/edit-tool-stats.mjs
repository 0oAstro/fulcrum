...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".fulcrum/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".fulcrum/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.fulcrum/sessions)
