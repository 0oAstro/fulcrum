...
class NotEnabled(RuntimeError):
    ...
    def __init__(self, server: str):
        ...
        super().__init__(
            ...
            f"Tell the user to run `/mcp login {server}` in Fulcrum to connect it. "
...
def _agent_dir() -> Path:
    """Resolve the Fulcrum config dir the same way the rest of the runtime does."""
    raw = os.environ.get("FULCRUM_CODING_AGENT_DIR") or str(Path.home() / ".fulcrum")
